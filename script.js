// التهيئة الآمنة لأيقونات Lucide لمنع تعطيل باقي الأكواد
...
const masterReviewsList = [
    ...
    { name: "فهد العتيبي", comment: "عرض اليوم الوطني رهيب! السعر 55 ريال واشتغال فوري على إيميلي الشخصي مع ضمان حقيقي طوال المدة." },
    ...
    { name: "محمد المالكي", comment: "الاشتراك رسمي ومضمون 100%. تم التفعيل على إيميلي وربطته على شاشة الصالة والجوال بدون أي مشاكل." },
    { name: "ابتسام الزهراني", comment: "تجربة ممتازة جداً. التفعيل على الإيميل الشخصي خلاني اتابع مسلسلاتي بخصوصية كاملة وبدون إزعاج." },
    ...
    { name: "هيا الدوسري", comment: "جربت متاجر كثيرة قبل بس هذا المتجر الوحيد اللي يفعل رسمي على إيميلك الشخصي مباشرة وبدون أي تعقيد." },
