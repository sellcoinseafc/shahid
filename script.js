...
// مصفوفة التقييمات التلقائية المحدثة بالكامل
const masterReviewsList = [
    ...
    { name: "خالد الدوسري", comment: "سرعة التفعيل تدرس! الخدمة رسمية على حسابي الشخصي (البريد الإلكتروني) وراحت عقدة الخروج المفاجئ وتجاوز عدد المتابعين." },
    ...
    { name: "محمد المالكي", comment: "الاشتراك رسمي ومضمون 100%. تم التفعيل على حسابي الشخصي (البريد الإلكتروني) وربطته على شاشة الصالة والجوال بدون أي مشاكل." },
